...
var XinShu69 = /** @class */ (function () {
    function XinShu69() {
        ...
        this.site = "https://www.69xinshu.com";
        this.version = "0.1.1";
    ...
    XinShu69.prototype.popularNovels = function (pageNo, _a) {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        novels = [];
                        novelsList = pageNo === 1 ? loadedCheerio('div.newbox > ul > li') : loadedCheerio('li');
                        novelsList.each(function () {
                            var novelUrl = loadedCheerio(this).find('li > div > h3 > a:nth-child(2)').attr('href');
                            if (novelUrl) {
                                var novelName = loadedCheerio(this).find('li > div > h3 > a:nth-child(2)').text();
    ...
    XinShu69.prototype.parseNovelAndChapters = function (novelUrl) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        novel.status = bookInfo.includes('连载') ? novelStatus_1.NovelStatus.Ongoing : novelStatus_1.NovelStatus.Completed;
                    ...
                    case 2:
                        ...
                        chaptersLoadedCheerio_1('li').each(function () {
                            var chapterUrl = chaptersLoadedCheerio_1(this).find('a').attr('href');
                            if (chapterUrl === null || chapterUrl === void 0 ? void 0 : chapterUrl.startsWith("https://")) {
                                var chapterName = chaptersLoadedCheerio_1(this).find('a').text().trim();
                                chapters.push({
                                    name: chapterName,
                                    url: chapterUrl,
                                });
    ...
    XinShu69.prototype.parseChapter = function (chapterUrl) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var body, loadedCheerio, chapterText;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, (0, fetch_1.fetchText)(chapterUrl, {}, 'gbk')];
                    case 1:
                        body = _b.sent();
                        loadedCheerio = (0, cheerio_1.load)(body);
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        loadedCheerio('div.newbox > ul > li').each(function () {
                            ...
                            var novelName = loadedCheerio(this).find('div.newnav > h3').text();
